		...
		return (
			<div className="list-books">
				...
				<div className="list-books-content">
					<div>
						<BookShelf books={this.state.allBooks} shelfTitle={"Currently Reading"}/>
						<BookShelf books={this.state.allBooks} shelfTitle={"Want to Read"}/>
						<BookShelf books={this.state.allBooks} shelfTitle={"Read"}/>
					</div>
				</div>
