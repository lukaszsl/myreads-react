		...
		return (
			<div className="list-books">
				...
				<div className="list-books-content">
					<div>
						<BookShelf books={this.state.booksCurrent} shelfTitle={"Currently Reading"}/>
						<BookShelf books={this.state.booksWant} shelfTitle={"Want to Read"}/>
						<BookShelf books={this.state.booksRead} shelfTitle={"Read"}/>
					</div>
				</div>
